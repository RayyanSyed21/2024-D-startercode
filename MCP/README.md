# Softeng Starter Code API MCP Server

This MCP (Model Content Protocol) server provides access to Softeng Starter Code API API functionality through HTTP, HTTPS, and STDIO transport modes.
